...
#   - Dados gerados (python3 scripts/gerar_dados_sinteticos.py)
#
# Execução:
#   cd fraud-detection
...
if [ ! -f "data/transacoes.csv" ]; then
    ...
    python3 scripts/gerar_dados_sinteticos.py
fi
echo "    ✓ Dados OK"
...
echo "$ python3 demo_job_retreinamento.py --usar-csv"
python3 demo_job_retreinamento.py --usar-csv
echo
